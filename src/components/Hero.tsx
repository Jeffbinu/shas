...
export default function Hero({
  ...
  return (
    <section className="relative min-h-[110vh] flex items-center overflow-hidden pt-10 pb-20 lg:pt-[8%] lg:pb-0">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        {/* 3. NOISE OVERLAY - The Key Fix */}
        {/* We use mix-blend-overlay and higher opacity (0.4) to make the grain visible like the design */}
        <div 
          className="absolute inset-0 opacity-[0.40] mix-blend-overlay z-10"
          style={{ 
            backgroundImage: "url('/hero/noise.jpg')", // Ensure this file exists!
            backgroundRepeat: "repeat",
            backgroundSize: "300px 300px" // Controls grain tightness
          }}
        ></div>
        
        {/* 4. Gradient overlay to smooth the noise at edges */}
      ...
      <div className="relative z-20 mx-auto px-6 lg:px-12 w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div className="flex flex-col justify-center order-2 lg:order-1">
          <h1 className="text-4xl sm:text-3xl md:text-3xl lg:text-[3rem] font-bold text-white leading-[1.1] mb-6 tracking-tight">
            {/* Split headline for design match if needed, or render as is */}
        ...
        {/* RIGHT COLUMN: 3D Illustration & Floating Cards */}
        <div className="order-1 lg:order-2 relative h-[450px] md:h-[600px] flex items-center justify-center lg:justify-end">
            ...
            <div className="relative w-full h-full max-w-[500px] flex items-center justify-center">
                ...
                {/* --- FLOATING UI CARDS (To match design 100%) --- */}
                
                {/* 1. Happy Customer Card (Right side) */}
                ...
                {/* 2. All Designers Card (Left/Bottom side) */}
                <div className="absolute bottom-[15%] left-[0%] lg:left-[-30px] bg-white p-4 rounded-2xl shadow-xl z-20 w-[200px] animate-float-reverse hidden sm:block">
                    <div className="flex justify-between items-center mb-2">
                        <span className="font-bold text-gray-800 text-xs">All Designers</span>
                        <span className="text-xs">🎨</span>
                    </div>
                    <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden mb-2">
                        <div className="bg-gradient-to-r from-blue-400 to-green-400 w-[62%] h-full"></div>
                    </div>
                ...
                {/* Platform / Cloud shadows underneath */}
                <div className="absolute bottom-[5%] w-[80%] h-[60px] bg-white/5 blur-[40px] rounded-full -z-10"></div>
            </div>
        </div>
      </div>
    </section>
